...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			global: { href: "assets/css/style.css", containers: '35em', grid: { gutters: ['1.5em', 0] } },
			large: { media: '(max-width: 1680px)', href: "assets/css/style-large.css" },
			medium: { media: '(max-width: 980px)', href: "assets/css/style-medium.css", containers: '80%', viewport: { scalable: false } },
			small: { media: '(max-width: 736px)', href: "assets/css/style-small.css", grid: { gutters: ['1em', 0] } },
